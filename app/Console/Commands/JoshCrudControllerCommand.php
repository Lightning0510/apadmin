...
class JoshCrudControllerCommand extends GeneratorCommand {
    ...
    protected function buildClass($name)
    {
        ...
        return $this->replaceNamespace($stub, $name)->replaceCrudName($stub, $crudName)->replaceCrudNameCap($stub, $crudNameCap)->replaceCrudNamePlural($stub, $crudNamePlural)->replaceCrudNamePluralCap($stub, $crudNamePluralCap)->replaceCrudNameSingular($stub, $crudNameSingular)->replaceCrudNameSingularCap($stub, $crudNameSingularCap)->replaceClass($stub, $name);
    }
