                        ...
                        <div class="panel panel-warning">
                            ...
                            <div class="panel-body">
                                <div class="owl-carousel owl-theme" id="carousel3">
                                    <div class="item"><img src="{{ asset('assets/img/parallax/photo1.jpg') }}" alt="image1"> </div>
                                    <div class="item"><img src="{{ asset('assets/img/parallax/photo2.jpg') }}" alt="image2"> </div>
                                    <div class="item"><img src="{{ asset('assets/img/parallax/photo3.jpg') }}" alt="image3"> </div>
                                    <div class="item"><img src="{{ asset('assets/img/parallax/photo1.jpg') }}" alt="image4"> </div>
                                    <div class="item"><img src="{{ asset('assets/img/parallax/photo2.jpg') }}" alt="image5"> </div>
                                </div>
                                <!-- End Carousel -->
                            </div>
                        </div>
